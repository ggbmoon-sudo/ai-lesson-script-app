...
第二份 `deep-research-report.md` 進一步把產品定位提升為「教材作業系統」：教材匯入後必須轉成可追溯、可重組的中介格式，再支援可編輯教材、可調時長講稿、以及只根據已發布教材回答的學生端助教。這份報告也明確要求治理層：AI 只產生草稿，教師負責發布，學生端只能讀 published revision。
...
- XLSX 工作表解析，可把課表、週次、時間與教學安排作為教材片段匯入。
- 教師可將目前草稿發布為 published revision，學生端只讀取發布快照。
- 學生問答頁支援 grounded-only 回答，答案會附投影片或教材片段來源。
